...
$techup_blog_title 	= get_theme_mod( 'techup_blog_title', __( 'Latest News', 'techup' ) );
$techup_blog_subtitle 	= get_theme_mod( 'techup_blog_subtitle' );
$techup_rm_button_label 	= get_theme_mod( 'techup_rm_button_label', __( 'Read More', 'techup' ) );
